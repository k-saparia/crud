...
import { deleteRedCache, getRedCache, setRedCache } from "../cache/redis.js";
...
export const getAllTodos = async (req, res) => {
  try {
    ...
    const cacheKey = "data:todos";
    const cacheData = await getRedCache(cacheKey);
    ...
    if (data.length !== 0) {
      const cacheKey = "data:todos";
      await setRedCache(cacheKey, data);
    }
